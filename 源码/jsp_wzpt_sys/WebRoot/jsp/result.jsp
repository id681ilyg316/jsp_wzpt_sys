	     ...
	     <%
	     	...
	     	if (ps.size() == 0) {
	     		...
	     		for (Post p : ps) {
	     			...
	     			out.print("<img src='/wzpt_sys/images/" + u.getUser_icon() + "' width='36px' height='36px'>");
	     ...
	     <p class="p_head" style="margin-top:20px">为您找到用户</p>
	       <%
	     	...
	     	if (uu.size() == 0) {
	     		...
	     		for (User ur : uu) {
	     			out.print("<div class='today_p_wrap'>");
	     			out.print("<img src='/wzpt_sys/images/" + ur.getUser_icon() + "' width='36px' height='36px'>");
	     			out.print("<p class='today_p u_p'>");
	     			out.print("&nbsp;<a href='/wzpt_sys/jsp/userdetail.jsp?uid=" +ur.getUser_id()+ "'>");
