	...
	<div id="content" class="center">
		...
		<div class="show">
			<tr>
				...
				<div class="user_icon">
					<p>
						当前头像：<img width="80px" height="80px"
							src="/wzpt_sys/images/${sessionScope['user'].getUser_icon()}">
					</p>
					<p>
				...
				<div class="show_image">
			     	<div class="imageDialog">
						...
						<div class="dialog_content">
							...
							<form name="uploadiconForm" action="/wzpt_sys/imageupload" enctype="multipart/form-data">
				...
				<p class="item buttom">
					<a href="/wzpt_sys/jsp/main.jsp">返回主页</a>
				</p>
		</div>
	</div>
	<div id="footer">
